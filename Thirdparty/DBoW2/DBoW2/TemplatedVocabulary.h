...
{
  std::cout << "templated line 462" << std::endl;
  load(filename);
}
...
{
  std::cout << "templated line 472" << std::endl;
  load(filename);
}
...
{
  std::cout << "templated line 481" << std::endl;//这句为什么在，编译的时候被调用了。
...
{
  std::cout << "templated line 519" << std::endl;
  m_scoring = type;
  createScoringObject();
}
...
{
  std::cout << "templated line 529" << std::endl;
...
TemplatedVocabulary<TDescriptor,F>::TemplatedVocabulary(
  ...
  : m_scoring_object(NULL)
{
  std::cout << "templated line 539" << std::endl;
  *this = voc;
}
...
{
  //std::cout << "templated line 1217" << endl;
  //std::cout << "scoring type is " << m_scoring_object-> <<
...
bool TemplatedVocabulary<TDescriptor,F>::loadFromBinaryFile(const std::string &filename) {
  std::cout << "templated line 1477" << std::endl;
  fstream f;

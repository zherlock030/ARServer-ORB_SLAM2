...
InitKeyFrame::InitKeyFrame(SystemSetting &SS):pVocabulary(SS.pVocabulary)//, pKeyFrameDatabase(SS.pKeyFrameDatabase)
{
    ...
    //cout << "initkf, fx is "<< fx << endl;

    //cout << "initkf, line 20 "<< endl;

    nScaleLevels = SS.nLevels;
    fScaleFactor = SS.fScaleFactor;
    //cout << "initkf, line 23 "<< endl;
    fLogScaleFactor = log(SS.fScaleFactor);
    //cout << "initkf, line 25 "<< endl;

    //cout << "vScaleFactors is "<<vScaleFactors[0] << endl;
    //cout << "initkf, line 26 "<< endl;
    vScaleFactors.resize(nScaleLevels);
    //cout << "initkf, line 26==== "<< endl;
    vLevelSigma2.resize(nScaleLevels);
    //cout << "initkf, line 26++++ "<< endl;
    //cout << "nscalelevels is " << nScaleLevels << endl;
    //cout << "vScaleFactors is "<<vScaleFactors[0] << endl;
    //cout << "vLevelSigma2 is "<<vLevelSigma2[0] << endl;
    //cout << "initkf, line 27 "<< endl;
    vScaleFactors[0] = 1.0f;
    //cout << "initkf, line 28 "<< endl;
    vLevelSigma2[0]  = 1.0f;
    //cout << "initkf, line 29 "<< endl;
    ...
    if( SS.DistCoef.at<float>(0)!=0.0)
    {
        ...
        //cout << "initkf, line 70 "<< endl;
    }
    else
    {
        //cout << "initkf, line 73 "<< endl;
        nMinX = 0.0f;
        nMaxX = SS.width;
        nMinY = 0.0f;
        nMaxY = SS.height;
        //cout << "initkf, line 80 "<< endl;
    }
...
void InitKeyFrame::UndistortKeyPoints()
{
    ...
    {
        //cout << "init::return at first "  << endl;
        vKpsUn = vKps;
        return;
    }
    ...
    for ( int i = 0; i < N; i ++ )
    {
      //cout << "I_th point" << vKps[i].pt.x <<"   " << vKps[i].pt.y << endl;
    ...
    //std :: cout << "initkf:: before undistor" << std::endl;
    mat = mat.reshape(2);
    cv::undistortPoints(mat, mat, K, DistCoef, cv::Mat(), K );
    mat = mat.reshape(1);
    //std :: cout << "initkf:: after undistor" << std::endl;
